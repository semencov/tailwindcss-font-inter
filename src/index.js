...
const mapObject = (obj, cb) => Object.fromEntries((Array.isArray(obj) ? obj : Object.entries(obj)).map(val => cb(...val)))
const filterObject = (obj, cb) => Object.fromEntries((Array.isArray(obj) ? obj : Object.entries(obj)).filter(val => cb(...val)))
...
module.exports = function (options = {}) {
  return ({ addBase, addUtilities, variants, e, theme }) => {
    ...
    const fontSizeUtilities = Object.entries(fontSizeTheme).reduce((result, [sizeModifier, sizeValue]) => {
